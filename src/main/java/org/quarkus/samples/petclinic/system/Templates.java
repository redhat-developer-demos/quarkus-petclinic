...
public class Templates {
    ...
    public static native TemplateInstance createOrUpdateOwnerForm(Owner owner);
    ...
    public static native TemplateInstance createOrUpdateVisitForm(Pet pet, Visit visit);
}
